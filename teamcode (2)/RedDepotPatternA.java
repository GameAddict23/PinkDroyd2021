...
public class RedDepotPatternA extends LinearOpMode {
    ...
    public void runOpMode(){
       ...
       //pulley = hardwareMap.get(DcMotor.class, "pulley"); 
        ...
        twinMotors(.5); //this part of the program allows the motors in front to move countinously until told otherwise 
        sleep(500);
